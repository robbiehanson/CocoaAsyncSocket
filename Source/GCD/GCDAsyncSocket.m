...
//    BOOL useIPv6 = ((preferIPv6 && address6) || (address4 == nil));
    ...
    return [self connectInternalWithAddress4:address4 address6:address6 error:errPtr tryIPv6:address6 != nil];
}

- (BOOL)connectInternalWithAddress4:(NSData *)address4 address6:(NSData *)address6 error:(NSError **)errPtr
                            tryIPv6:(BOOL)tryIPv6
{
    LogTrace();
        ...
        else
        {
            if (useIPv6) {
                dispatch_async(strongSelf->socketQueue, ^{
                    [self connectInternalWithAddress4:address4 address6:address6 error:errPtr tryIPv6:NO];
                });
            } else {
